...
public class ImagePostersAdapter extends CursorAdapter {

    //private Context mContext;
    //private List<ImagePoster> posterList;
    private static final String LOG_TAG = "Provider";
    private static final String BASE_IMAGE_URL = "http://image.tmdb.org/t/p/w342";
    public ImagePostersAdapter(Context context, Cursor c, int flags) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        View view = LayoutInflater.from(context).inflate(R.layout.image_poster, parent, false);
