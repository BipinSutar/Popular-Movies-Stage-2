...
public class MovieProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher(){
        ...
        //content://bipin.popular_movies_2.app/poster/84
    ...
    private Cursor getPosters(
            Uri uri, String [] projection_array, String sortOrder){
    ...
    private Cursor getTrailers(Uri uri, String [] projection_array, String sortOrder, String selection, String [] selectionArgs){
    ...
    @Nullable
    @Override
    public Cursor query(Uri uri, String[] projection_array, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch(match){
            case POSTER:{
                cursor = getPosters(uri, projection_array, sortOrder);
            }break;

            case POSTER_WITH_ID:{
                cursor = getPostersWithId(uri, projection_array, sortOrder);
            }break;
            ...
            case POSTER_WITH_SORTING_AND_MIN_VOTES:{
                cursor = getPostersWithMinVotes(uri, projection_array, sortOrder);
            }break;

            case TRAILER:{
                //cursor = getTrailersFromMovie(uri,projection_array,sortOrder);
                cursor = getTrailers(uri, projection_array, sortOrder, selection, selectionArgs);
            }break;
