...
import bipin.popular_movies_2.test.RetrieveTrailersTask;
...
public class RetrieveMoviesTask extends AsyncTask <String, Void, Void> {
    ...
    public RetrieveMoviesTask(ImagePostersAdapter mPosterAdapter, Context mContext, GridView postersGrid, int landscape_columns, int portrait_columns, SwipeRefreshLayout mSwipeRefreshLayout) {
